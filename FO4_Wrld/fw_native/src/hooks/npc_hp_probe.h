...
// Shared-HP pool is compiled out (see fw_native/minimal_exclude.txt).
// main_thread_dispatch.cpp keeps compiling against these stubs.
inline bool install_npc_hp_probe(std::uintptr_t) { return false; }

inline void set_hp_probe_enabled(bool)   noexcept {}
inline void set_hp_capture_enabled(bool) noexcept {}
inline void set_hp_clamp_enabled(bool)   noexcept {}
inline void apply_pool_health_to_actor(void*, float, float) noexcept {}

inline std::uint64_t get_hp_probe_fires()    noexcept { return 0; }
inline std::uint64_t get_hp_probe_captures() noexcept { return 0; }
inline std::uint64_t get_hp_probe_clamps()   noexcept { return 0; }
inline std::uint64_t get_hp_probe_seh()      noexcept { return 0; }
