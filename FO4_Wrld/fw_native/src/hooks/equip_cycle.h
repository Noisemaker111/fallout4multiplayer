...
// Equipment sync is compiled out (see fw_native/minimal_exclude.txt). Ghosts
// spawn naked; they still move, which is all a first playable build needs.
// main_menu_hook.cpp and net/client.cpp keep compiling against these stubs.
inline void arm_equip_cycle_after_loadgame(unsigned int) {}
inline void arm_equip_cycle_for_peer_join(unsigned int) {}
inline void on_force_equip_cycle_unequip_message() {}
inline void on_force_equip_cycle_equip_message() {}
inline void shutdown_equip_cycle() {}
